...
[**`cli_mode.py`**](https://github.com/wildfielded/samples-python/blob/master/cli_mode.py) -
...
[**`win_mode.py`**](https://github.com/wildfielded/samples-python/blob/master/win_mode.py) -
